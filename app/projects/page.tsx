        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground">
              Real-world applications where I've applied modern web development practices, 
              solved complex problems, and learned valuable lessons along the way.
            </p>
          </motion.div>
              ...
              >
                ...
                <div className="space-y-4">
                  {project.images.map((img, imgIndex) => (
                    <div
                      key={imgIndex}
                      className="relative w-full h-auto rounded-lg overflow-hidden border border-border/50 bg-muted/30"
                    >
                      <img
                        src={img}
                ...
                {/* Architecture */}
                <div className="space-y-3">
                  <h3 className="text-lg font-semibold text-foreground">Architecture & Approach</h3>
